...
class HtmlTagCreatorTest {
    ...
    private void setUpTestHtmlData() {
        ...
        ReflectionTestUtils.setField(testHtmlData, "htmlTemplate", "<i class=\"iconName\" style=\"color: iconColor; font-size: iconSize; margin-bottom: 8px; margin-top: marginTop; margin-right: 2x\"></i>");
        ...
        Map<String, WeatherCondition> conditionMappings = new HashMap<>();
    ...
    void testCreateMainTag() {
        String expected = "<i class=\"fas fa-sun\" style=\"color: #ff8c00; font-size: 75px; margin-bottom: 8px; margin-top: 17px; margin-right: 2x\"></i>";
    ...
    void testCreateSubTag() {
        String expectedBig = "<i class=\"fas fa-sun\" style=\"color: #a9a9a9; font-size: 55px; margin-bottom: 8px; margin-top: 0px; margin-right: 2x\"></i>";
        String resultBig = htmlTagCreator.createSubTag("Sunny", "big");

        assertEquals(expectedBig, resultBig);

        String expectedSmall = "<i class=\"fas fa-sun\" style=\"color: #a9a9a9; font-size: 40px; margin-bottom: 8px; margin-top: 0px; margin-right: 2x\"></i>";
